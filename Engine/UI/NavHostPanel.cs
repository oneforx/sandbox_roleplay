...
/// </summary>
[Library("navigator")]
public class NavHostPanel : Panel
{
	/// <summary>
	...
	public void Navigate(string url, bool redirectToDefault = true)
	{
		...
		//
		var parent = Ancestors.OfType<NavHostPanel>().FirstOrDefault();
		...
		if (foundPartial)
		{
			var childNavigator = Current.Panel as NavHostPanel;

			if (childNavigator == null)
				childNavigator = Current.Panel.Descendants.OfType<NavHostPanel>().FirstOrDefault();
...
public static class NavigationExtensions
{
	...
	{
		panel.AncestorsAndSelf.OfType<NavHostPanel>().FirstOrDefault()?.Navigate(url);
	}
}
